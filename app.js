...
function displayManuItems (menuItems){
  let displayMenu = menuItems.map(function(item){
    ...
    <img src=${item.img} class="photo" alt="manu item">
    <div class="item-info">
      <header>
        <h4>${item.title}</h4>
...
window.addEventListener('DOMContentLoaded', function(){
  let displayManu = menu.map(function(item){
    // console.log(item);
    return `<article class="menu-item">
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  // btnContainer.innerHTML = categores;
});
...
const displayManuItems = function (menuItems) {
  let displayManu = menuItems.map((item) => {
    // console.log(item);
    return `
      <article class="menu-item">
